...
public class CoreRebecaActorState extends CoreRebecaAbstractState implements Serializable {
	...
	private ArrayList<CoreRebecaMessage> queue;

	public CoreRebecaActorState(String id) {
		this.id = id;
	...
	public CoreRebecaMessage getFirstMessage() {
		return queue.remove(0);
	}
	
	public void receiveMessage(CoreRebecaMessage newMessage) {
