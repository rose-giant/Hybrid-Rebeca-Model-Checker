...
public class HybridRebecaInternalProgressSOSRule extends AbstractHybridSOSRule<HybridRebecaActorState> {
    ...
    HybridRebecaAbstractTransition<HybridRebecaActorState> convertStatementResultToActorResult(
            HybridRebecaAbstractTransition<Pair<HybridRebecaActorState, InstructionBean>> result) {

        if (result instanceof HybridRebecaDeterministicTransition<Pair<HybridRebecaActorState, InstructionBean>> det) {
            return new HybridRebecaDeterministicTransition<>(det.getAction(), det.getDestination().getFirst());
        }
        else if (result instanceof HybridRebecaNondeterministicTransition<Pair<HybridRebecaActorState, InstructionBean>> nondet) {
            HybridRebecaNondeterministicTransition<HybridRebecaActorState> newTransition = new HybridRebecaNondeterministicTransition<>();
            for (Pair<? extends Action, Pair<HybridRebecaActorState, InstructionBean>> d: nondet.getDestinations()) {
