...
@Component
public class RealTimeRebecaVariableDeclarationSOSRule extends AbstractRealTimeSOSRule<Pair<RealTimeRebecaActorState, InstructionBean>> {
    @Override
    ...
    @Override
    public RealTimeRebecaAbstractTransition<Pair<RealTimeRebecaActorState, InstructionBean>> applyRule(Action synchAction, org.rebecalang.compiler.utils.Pair<RealTimeRebecaActorState, InstructionBean> source) {
        return null;
    }
}
